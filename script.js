...
const locations = [
  ...
  {
    name: "store",
    "button text": ["Buy 10 health (10 gold)", "Buy weapon (30 gold)", "Go to town sqare"],
    "button functions": [buyHealth, buyWeapon, goTown],
    text: 'You are in the town square. You see a sign that says "store." ',
  },
  {
    name: "cave",
    "button text": ["Fight slime", "Fight fanged beast", "Go to town sqare"],
...
function sellWeapon() {
  if (inventory.length > 1) {
    gold += 15;
    goldText.innerText = gold;
    let currentWeapon = inventory.shift(); //shift() use to remove 1st element of the array
